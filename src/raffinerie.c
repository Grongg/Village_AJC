...
void addToRaffinerie(S_raffinerie *raffinerie, S_hotelDeVille *hdv)
{
    raffinerie->nbActuelVillageois++;
    hdv->villageois--;
}

void removeFromRaffinerie(S_raffinerie *raffinerie, S_hotelDeVille *hdv)
{
    raffinerie->nbActuelVillageois--;
    hdv->villageois++;
}
